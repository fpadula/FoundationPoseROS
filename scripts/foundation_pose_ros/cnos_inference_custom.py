...
from cnos.src.model.utils import Detections, convert_npz_to_json
from cnos.src.model.loss import Similarity
from cnos.src.utils.inout import save_json_bop23
import cv2
import distinctipy
from skimage.feature import canny
from skimage.morphology import binary_dilation
from cnos.segment_anything.utils.amg import rle_to_mask
...
def visualize(rgb, detections, save_path="./cnos/tmp/tmp.png"):
    img = rgb.copy()
...
def run_inference(
    template_dir, rgb_path, num_max_dets, conf_threshold, stability_score_thresh
):
    with initialize(version_base=None, config_path="./cnos/configs"):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--template_dir", nargs="?", help="Path to root directory of the template"
    )
